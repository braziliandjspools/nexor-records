...
// Componente para a lista de programas (sem 'export default')
        ...
        <div className="sticky top-24 space-y-4">
          <div className="relative">
            ...
            <Input
              ...
              className="w-full pl-10 bg-slate-900 border-slate-700 focus:border-purple-500"
              value={searchQuery}
          ...
          <div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="w-full justify-between bg-slate-800 border-slate-700 hover:bg-slate-700">
                  {selectedCategory}
...
// --- Componente Principal da Página (O ÚNICO com 'export default') ---
